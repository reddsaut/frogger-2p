...
{
	Exception_t* ___m_CharacterElementException = il2cpp_codegen_get_marshal_directive_exception("Cannot marshal field 'm_CharacterElement' of type 'TextProcessingElement'.");
